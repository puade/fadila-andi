  ...
  if (recipientName) {
    const newUrl = `https://puade.github.io/fadila-andi/?kepada=${recipientName}`;
    ...
    // Countdown function
    function countdown() {
      const countDate = new Date("September 19, 2026 19:00:00").getTime();
...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbzWcwzmYggYpxkmTHDTrOQMtExpByxLtRD71rhfPwosnjRpNK2S1UyQLtb643uBFon9/exec'; // Ganti dengan URL Web App Google Apps Script Anda
...
document.getElementById('formPernikahan').addEventListener('submit', function(event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbzWcwzmYggYpxkmTHDTrOQMtExpByxLtRD71rhfPwosnjRpNK2S1UyQLtb643uBFon9/exec', {
    method: 'POST',
